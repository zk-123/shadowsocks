...
public class CipherProvider {
    ...
    static {
        /* aes */
        cipherMap.put("aes-128-ctb",Aes128CfbCipher.class);
        cipherMap.put("aes-192-ctb",Aes128CfbCipher.class);
        cipherMap.put("aes-256-ctb",Aes128CfbCipher.class);

        /* camellia */
        cipherMap.put("camellia-128-cfb",Aes128CfbCipher.class);
        cipherMap.put("camellia-192-cfb",Aes128CfbCipher.class);
        cipherMap.put("camellia-256-cfb",Aes128CfbCipher.class);

        /* chacha20 */
        cipherMap.put("chacha20",Aes128CfbCipher.class);
        cipherMap.put("chacha20-ietf",Aes128CfbCipher.class);

        /*others stream cipher */
        cipherMap.put("rc4-md5",Aes128CfbCipher.class);
        cipherMap.put("salsa20",Aes128CfbCipher.class);
    }
